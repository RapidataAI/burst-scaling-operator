...
func (in *GCPSecretManager) DeepCopyInto(out *GCPSecretManager) {
	*out = *in
	...
	if in.Credentials != nil {
		in, out := &in.Credentials, &out.Credentials
		*out = new(GCPSecretManagerCredentials)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GCPSecretManagerCredentials) DeepCopyInto(out *GCPSecretManagerCredentials) {
	*out = *in
	out.ClientSecret = in.ClientSecret
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GCPSecretManagerCredentials.
func (in *GCPSecretManagerCredentials) DeepCopy() *GCPSecretManagerCredentials {
	if in == nil {
		return nil
	}
	out := new(GCPSecretManagerCredentials)
